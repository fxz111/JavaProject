  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" width="450" align="center">
        <template slot-scope="scope">
            <el-button type="primary" size="mini" icon="el-icon-edit" @click="editCourse(scope.row.id)">编辑课程信息</el-button>
            <el-button type="success" size="mini" icon="el-icon-edit" @click="editCV(scope.row.id)">编辑课程大纲</el-button>
