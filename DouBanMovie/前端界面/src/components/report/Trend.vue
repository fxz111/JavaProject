...
export default {
  ...
  methods: {
    ...
    updateChart() {
      // 半透明的颜色值
      const colorArr1 = ['rgba(11, 168, 44, 0.5)', 'rgba(44, 110, 255, 0.5)', 'rgba(22, 242, 217, 0.5)', 'rgba(254, 33, 30, 0.5)', 'rgba(250, 105, 0, 0.5)','rgba(255, 191, 0, 0.5)', 'rgba(55, 162, 255, 0.5)']
      // 全透明的颜色值
      const colorArr2 = ['rgba(11, 168, 44, 0)', 'rgba(44, 110, 255, 0)', 'rgba(22, 242, 217, 0)', 'rgba(254, 33, 30, 0)', 'rgba(250, 105, 0, 0)','rgba(224, 62, 76, 0)', 'rgba(116, 21, 219, 0)',]

      // x轴数据
      const year = this.allData.year
      // y轴数据 series下的数据
      const valueArr = this.allData[this.activeName].data.list
