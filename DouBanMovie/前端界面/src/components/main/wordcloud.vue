    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="word" label="热点词" align="center"></el-table-column>
                <el-table-column prop="num" label="出现频率" align="center"></el-table-column>
...
export default {
    ...
    methods: {
        // 获取 easy-mock 的模拟数据
        getData() {
            word.getList(this.page,this.limit,this.word).then(res => {
