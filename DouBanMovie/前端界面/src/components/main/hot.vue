    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="movieType" label="电影类型" align="center" width="100"></el-table-column>
                <el-table-column prop="year" label="年份" align="center" width="150"></el-table-column>
                <el-table-column prop="num" label="当年热度" align="center"></el-table-column>
