    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="movieType" label="电影类型" align="center"></el-table-column>
                <el-table-column prop="movieArea" label="电影产地" align="center"></el-table-column>
                <el-table-column prop="movieLength" label="电影时长" align="center"></el-table-column>
                <el-table-column prop="movieTime" label="发布时间" align="center"></el-table-column>
...
export default {
    ...
    methods: {
        // 获取 easy-mock 的模拟数据
        getData() {
            movie.getList(this.page,this.limit,this.moviename).then(res => {
