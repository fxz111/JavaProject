    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="movieType" label="电影类型" align="center" width="200"></el-table-column>
                <el-table-column prop="year" label="年份" align="center" width="200"></el-table-column>
                <el-table-column prop="num" label="当年评分" align="center"></el-table-column>
...
export default {
    ...
    methods: {
        // 获取 easy-mock 的模拟数据
        getData() {
            score.getList(this.page,this.limit,this.movieType).then(res => {
