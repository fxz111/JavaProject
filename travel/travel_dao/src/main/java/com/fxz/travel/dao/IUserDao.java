...
public interface IUserDao {
    ...
    @Results({
            ...
            @Result(property = "roles",column = "id",javaType = java.util.List.class,many = @Many(select = "com.fxz.travel.dao.IRoleDao.findRoleByUserId"))
    })
    ...
    public void deleteUser_Role(String id);
