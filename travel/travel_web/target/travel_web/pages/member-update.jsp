...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/member/update.do?id=${member.id}"
              method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="name"
                                    value="" placeholder="${member.name}">
                        </div>
                        <div class="col-md-2 title">会员昵称</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="nickName"
                                    value="" placeholder="${member.nickName}">
                        </div>

                        <div class="col-md-2 title">电话号码</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="phoneNum"
                                    value="" placeholder="${member.phoneNum}">
                        </div>
                        <div class="col-md-2 title">邮箱</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control"
                                   name="email" value="" placeholder="${member.email}">
                        </div>
                    </div>
                </div>
                <!--订单信息/--> <!--工具栏-->
