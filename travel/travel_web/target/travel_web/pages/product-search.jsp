                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="开启" onclick="openpro()"><i class="fa fa-check" ></i> 开启</button>
                                    <button type="button" class="btn btn-default" title="关闭" onclick="closepro()"><i class="fa fa-ban" ></i> 关闭</button>
                                </div>
                            </div>
                        </div>
                        <form action="${pageContext.request.contextPath}/product/findByName.do" method="post">
                            <div class="box-tools pull-right">
                                <input type="text" class="form-control input-sm" placeholder="产品名称" name="productName"/>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${productList}" var="product">
                                <tr>
                                    <td><input id="sel" name="ids" type="checkbox" value="${product.id}"></td>
                                    <td>${product.id}</td>
...
<script>
    function ck() {
        ...
        location.href = "${pageContext.request.contextPath}/product/deleteById.do?ids="+ids;
    }
    function openpro() {
        var ids = "";
        $(":checkbox:checked").each(function(i){
        ...
        location.href = "${pageContext.request.contextPath}/product/updateById.do?flag=1&ids="+ids;
    }
    function closepro() {
        var ids = "";
        $(":checkbox:checked").each(function(i){
        ...
        location.href = "${pageContext.request.contextPath}/product/updateById.do?flag=0&ids="+ids;
    }
