...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/traveller/update.do?id=${traveller.id}"
              method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="name"
                                   placeholder="${traveller.name}" value="">
                        </div>
                        <div class="col-md-2 title">性别</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="sex"
                                   placeholder="${traveller.sex}" value="">
                        </div>
                        <div class="col-md-2 title">电话号码</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="phoneNum"
                                   placeholder="${traveller.phoneNum}" value="">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="${traveller.credentialsNum}"
